...
public class SimpleCall {
    ...
    public static Map<String, Object> makeParam(String[] args, Object[] objects){
        final Map<String, Object> params = new HashMap<>();
        for(int e = 0; e < args.length; e++){
            if(objects.length > e) params.put(args[e], objects[e]);
            else params.put(args[e], null);
        }
    ...
    public static Map<String, Object> makeParam(String args, Object objects){
        Map<String, Object> params = makeParam(new String[]{args}, new Object[]{objects});
        return params;
    }
